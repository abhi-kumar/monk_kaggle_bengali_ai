...
def get_base_system_dict():
    ...
    #If kaggle competition
    system_dict["kaggle"] = {};
    system_dict["kaggle"]["status"] = False;
    system_dict["kaggle"]["competition"] = False;
    system_dict["kaggle"]["dataset"] = {};
    system_dict["kaggle"]["dataset"]["data_root"] = False;
    system_dict["kaggle"]["dataset"]["parquet_files_train"] = False;
    system_dict["kaggle"]["dataset"]["parquet_files_test"] = False;
    system_dict["kaggle"]["dataset"]["csv_train"] = False;
    system_dict["kaggle"]["dataset"]["csv_test"] = False;
    system_dict["kaggle"]["dataset"]["target"] = False;
    system_dict["kaggle"]["dataset"]["read"] = False;
    system_dict["kaggle"]["dataset"]["percent_data"] = False;
